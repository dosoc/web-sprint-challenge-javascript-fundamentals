...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The nested fuction has access to the lexical scope of myFunction();
// functions have access looking outward but not inward
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(arr){
    const habitats = [];
    arr.forEach(e => habitats.push(`name: ${e.animal_name}, scientific: ${e.scientific_name}`))
    return habitats
  }
  ...
  */
  ...
  function lowerCaseNames(arr){
    return arr.map(e => e.animal_name.toLowerCase())
  }
